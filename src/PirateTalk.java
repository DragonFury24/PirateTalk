...
public class PirateTalk {
    ...
    public void initialize() throws IOException {
        int numWords;
        numWords = filesScanner.getFileSize(new File("src").exists() ? "src/english.txt" : "english.txt");
        ...
        filesScanner.readFile(englishWords, new File("src").exists() ? "src/english.txt" : "english.txt");
        filesScanner.readFile(pirateWords, new File("src").exists() ? "src/pirate.txt" : "pirate.txt");
    ...
    public Map<String, ArrayList<String>> flip() {
        ...
        for (String englishWord : englishToPirate.keySet()) {
            ...
            if (!ans.containsKey(pirateWord)) {
                ans.put(pirateWord, new ArrayList<String>());
